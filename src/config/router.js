...
const routes = [
    ...
    },
    {
        ...
        name: 'DepositPay',
        component: () => import('../page/deposit/index'),
        meta: {
            title: '押金缴纳'
        }
    }, {
        name: 'DepositRefund',
        component: () => import('../page/deposit/refund'),
        meta: {
            title: '申请退款'
        }
    },
    {
        name: 'DepositRecord',
        component: () => import('../page/deposit/record/index'),
        meta: {
            title: '缴纳记录'
        }
    }, {
        name: 'DepositRefundRecord',
        component: () => import('../page/deposit/refund/index'),
        meta: {
            title: '退款记录'
        }
    },
